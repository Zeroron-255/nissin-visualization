...
MONGO_URI = "mongodb://localhost/nissin"  # "mongodb://接続先MongoDBのドメイン(localhost)/DB名(nobel_prize)"
...
DOMAIN = {"nutrient":{    # 公開するmongodbコレクション名
    ...
    "product":{    # 公開するmongodbコレクション名
    "item_title": "product",  # APIで取得できるJSONファイルにおけるkey
    "url":"product",          # このAPIの公開用のURL．ここでは http://localhost:50000/api/winners
    "schema":{
            "id":{"type":"string"},
            "name":{"type":"string"},
